...
function searchRun(s)
{
    ...
    var artists = searchTestList(g_searchData.artists,re,true,"artist","");
    var songs = searchTestList(g_searchData.songs,re,false,"song","");
    var videos = searchTestList(g_searchData.videos,re,false,"video","");
    var photos = searchTestList(g_searchData.photos,re,false,"photo","");
