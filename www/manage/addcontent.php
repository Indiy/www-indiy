...
<div id="popup">
    ...
    <form id='ajax_form' method="post" enctype="multipart/form-data" action="addcontent.php" onsubmit='return onAddContentSubmit();'>
        ...
        <div class='input_container'>
            <div class='left_label'>Name of Tab<span id='tip_tab_name' class='tooltip'>(?)</span><span class='required'>*</span></div>
        ...
        <div class='submit_branding_container'>
            ...
            <div class='branding_tip' style='width: 400px;'>The more info you add about yourself the better chance your account will be found. </div>
        </div>
    </form>
