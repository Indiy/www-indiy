<?php
	...
	if ($_POST["submit"] != "") {
		...
		if (is_uploaded_file($_FILES["logo"]["tmp_name"])) {
			$content_logo = $_SESSION["me"]."_".strtolower(rand(11111,99999)."_".basename(cleanup($_FILES["logo"]["name"])));
		...
		$values = "{$_SESSION["me"]}|{$content_name}|{$content_logo}|{$content_video}|{$content_body}";
				...
				<div id="content">
					...
					<div class="post">
						...
						<form method="post" enctype="multipart/form-data">
							...
							<? if ($_GET["id"] != "") { ?>
							<p><br /><br />
							<a href="#" class="xdelete" onclick="confirmDelete('?p=home&delete=true&type=content&a=<?=$_SESSION["me"];?>&id=<?=$content_id;?>')"><small>Delete</small></a></p>
							<? } ?>						
						</form>
					</div>
